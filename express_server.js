...
// Helper Function used in app.get("/urls")
...
app.get("/urls/:shortURL", (req, res) => {
  ...
  if (urlLookupResult.userID === userID) {
    const templateVars = {
      ...
      longURL: urlLookupResult.longUrl,
...
//Generates a random string for a shortUrl, assigns to a long Url and to an Id.
...
// Allows the shortUrl to Direct to the Long url
...
// Edits a Users LongUrl stored to a shortUrl
...
app.post("/register", (req, res) => {
  ...
  // Check that the email doesn't already exist in the users database.
  ...
  // Add the new user object to the global users database
